...
$url = 'https://402q6w62cj.execute-api.us-east-1.amazonaws.com/prod/postLocation';
...
<form>
	...
	<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect"input type="submit" name="AddLocation">
  Add
</button>
</form>
<?php
